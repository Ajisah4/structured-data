...
<EpicVideo url="https://www.epicweb.dev/tutorials/structured-data/5-array-methods/reduce/solution" />
...
<callout-info>
	**Immutable vs mutable accumulators:** We used the spread pattern
	...
	Pragmatism wins—choose based on your actual data size and readability needs.
</callout-info>
